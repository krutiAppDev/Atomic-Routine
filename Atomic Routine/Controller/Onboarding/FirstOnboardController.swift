...
class FirstOnboardController: UIViewController {
   ...
   @IBAction func nextButtonPressed(_ sender: UIButton) {
      var next = storyboard?.instantiateViewController(identifier: "SecondOnboardController") as! SecondOnboardController
